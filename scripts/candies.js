var candies = {
    ...
    setNbrOwned : function(value){
        ...
        this.nbrOwned = value;
        if(this.nbrOwned != 1) htmlInteraction.setInnerHtml("candies", "У вас " + this.nbrOwned + " конфет!");
        else htmlInteraction.setInnerHtml("candies", "У вас 1 кофета!");
    ...
    setNbrEaten : function(value){
        this.nbrEaten = value;
        if(this.nbrEaten != 1) htmlInteraction.setInnerHtml("candies_eaten", "Съедено " + this.nbrEaten + " конфет!");
        else htmlInteraction.setInnerHtml("candies_eaten", "Вы съели 1 конфету!");
    ...
    setNbrThrown : function(value){
        ...
        if(this.nbrThrown != 1) htmlInteraction.setInnerHtml("candies_thrown", "Вы выбросили" + this.nbrThrown + " конфет" + smiley);
        else htmlInteraction.setInnerHtml("candies_thrown", "Вы выбросили 1 конфету" + smiley);
